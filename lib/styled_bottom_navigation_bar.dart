library styled_bottom_navigation_bar;
...
import 'style/bottom_navigation_bar_style.dart';
...
class StyledBottomNavigationBar extends StatefulWidget {
  ...
  @override
  State<StyledBottomNavigationBar> createState() => _BottomNavigationBarState();
}
...
class _BottomNavigationBarState extends State<StyledBottomNavigationBar>
  ...
  @override
  void didUpdateWidget(StyledBottomNavigationBar oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    final double additionalBottomPadding =
        MediaQuery.of(context).padding.bottom +
            (widget.style.innerBoxMargin?.vertical ?? 0) / 2;
            ...
            child: Material(
              ...
              child: Padding(
                padding: EdgeInsets.only(
                  left: (widget.style.innerBoxMargin?.horizontal ?? 0) / 2,
                  right: (widget.style.innerBoxMargin?.horizontal ?? 0) / 2,
                ...
                child: MediaQuery.removePadding(
                  ...
                  child: DefaultTextStyle.merge(
                    ...
                    child: DecoratedBox(
                      decoration: widget.style.innerBoxDecoration ??
                          const BoxDecoration(),
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
